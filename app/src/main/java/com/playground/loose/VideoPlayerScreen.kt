                            ...
                            when (gestureType.value) {
                                ...
                                GestureType.BRIGHTNESS -> {
                                    ...
                                    activity?.window?.attributes =
                                        activity.window.attributes.apply { screenBrightness = nb }
                                ...
                                GestureType.SEEK -> {
                                    ...
                                    val baseWindow = max(10_000L, duration / 4L) // base sensitivity
                                    val deltaMs = (fraction * baseWindow).roundToLong()
                                    seekPreviewDeltaMs =
                                        (seekPreviewDeltaMs + deltaMs).coerceIn(-duration, duration)
                                    seekPreviewPosition =
                ...
                Column(modifier = Modifier
                    ...
                    ActionRowAboveSeek(
                        ...
                        onRotate = {  isLandscape = !isLandscape
                            activity?.requestedOrientation = if (isLandscape) ActivityInfo.SCREEN_ORIENTATION_SENSOR_LANDSCAPE else ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT
                        },
                        onToggleAudioOnly = {
