...
import com.playground.screens.presentation.uistate.FeatureItem
import com.playground.screens.presentation.uistate.WelcomeUiState
...
fun WelcomeScreenPreview() {
    MaterialTheme(
        colorScheme = darkColorScheme(
            background = Color(0xFF232C2B),
            onBackground = Color(0xFFFFFFFF),
            surface = Color(0xFF232C2B),
